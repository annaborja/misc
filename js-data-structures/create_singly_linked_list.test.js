const createSinglyLinkedList = require('./create_singly_linked_list');
...
describe('initialization', () => {
  ...
  describe('when an iterator is passed in', () => {
    test('creates a list from the data', () => {
      const list = createSinglyLinkedList([1, 2, 3]);
...
describe('iterator', () => {
  describe('when the list is empty', () => {
    test('iterates through the list', () => {
      expect([...createSinglyLinkedList()]).toEqual([]);
    });
  });

  describe('when the list contains one element', () => {
    test('iterates through the list', () => {
      expect([...createSinglyLinkedList([1])]).toEqual([1]);
    });
  });

  describe('when the list contains multiple elements', () => {
    test('iterates through the list', () => {
      expect([...createSinglyLinkedList([1, 2, 3])]).toEqual([1, 2, 3]);
    });
  });
});
...
describe('contains', () => {
  describe('when the list is empty', () => {
    test('returns false', () => {
      expect(createSinglyLinkedList().contains(42)).toBe(false);
    });
  });
  ...
  describe('when the list contains one element', () => {
    describe('when an element contains the datum', () => {
      test('returns true', () => {
        expect(createSinglyLinkedList([42]).contains(42)).toBe(true);
      });
    });

    describe('when no element contains the datum', () => {
      test('returns false', () => {
        expect(createSinglyLinkedList([1]).contains(42)).toBe(false);
      });
    });
  });
  ...
  describe('when the list contains multiple elements', () => {
    describe('when an element contains the datum', () => {
      test('returns true', () => {
        expect(createSinglyLinkedList([1, 42, 3]).contains(42)).toBe(true);
      });
    });

    describe('when no element contains the datum', () => {
      test('returns false', () => {
        expect(createSinglyLinkedList([1, 2, 3]).contains(42)).toBe(false);
      });
    });
  });
});
...
describe('remove', () => {
  ...
  describe('when the list contains one element', () => {
    describe('when an element contains the datum', () => {
      test('removes the datum element from the list', () => {
        const list = createSinglyLinkedList([42]);
  ...
  describe('when the list contains multiple elements', () => {
    describe('when the element at the start contains the datum', () => {
      test('removes the datum element from the list', () => {
        const list = createSinglyLinkedList([42, 1, 2]);
    ...
    describe('when an element in the middle contains the datum', () => {
      test('removes the datum element from the list', () => {
        const list = createSinglyLinkedList([1, 42, 3]);
    ...
    describe('when the element at the end contains the datum', () => {
      test('removes the datum element from the list', () => {
        const list = createSinglyLinkedList([1, 2, 42]);
